...
function Competitions() {
    ...
    const competitionsData = {
        "AI Coding Hackathon Cologne": {
            description: "The AI Coding Hackathon in Cologne is about creating interesting and useful projects in 48 hours with Vibe Coding tools like n8n, Base44, ElevenLabs, ... My team and I created 'ExamAI' ",
        ...
        "HackHPI": {
            description: "HackHPI 2026 was about agriculture, climate & tech",
            ranking: "-- Ongoing --",
            link: null
        },
        "Summer of Making": {
